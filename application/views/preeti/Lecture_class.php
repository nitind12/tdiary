  ...
  <div class="module">
    ...
    <div class="btn-box-row row-fluid" >
      <?php foreach($cls_in_session as $item){?>
        ...
        <div class="btn-box-row row-fluid  span5"style="background:#f0f0f0;  border-radius:12px;   padding:3px;  vertical-align:top;      
             color: #000090; border: #808080 dotted 1px; margin: 10px">
