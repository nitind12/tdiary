...
<div class="span9">
	<div class="content">
		<div class="module">
   		...
   		<form  method="post" name="myEdit"  id="myEdit"   action="<?php 0_url('Edit_controller/lecture_saving_data/'.$item->add_class_id.'/'.$item->session_id.'/'.$item->course_id);?>"  class="form-horizontal row-fluid">
