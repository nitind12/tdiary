...
<div class="content">
 ...
 <div class="module-body">
  <form name="frmtotal2" id="frmtotal2"  Method="POST" >
      ...
      <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-striped  display" width="100%">
                ...
                <tr>
                  ...
                  <div class="control-group">
                      <div class="controls">
                        ...
                        <input type="submit"class="btn btn-primary" value="Search" id="cmbstudenttotal">
                      </div>
                    </div>
                  </div>
                  </td>
        ...
        <table class="table table-bordered table-striped" id="reportshereT" name="reportshereT">
            </table>
   </div></div></div>