<div class="span8">
	...
	<table class="table table-striped table-bordered table-condensed" id="s9" name="s9" border="1">
				...
				<tbody>
									...
									<tr>
									  ...
									  <td>date_of_commencement:<br>
									  	<input type="number" name="father_name" class="span8" required/></td>
									  
									  <td>faculty_id:<br>
									  	<input type="number" name="mother_name" class="span8" required/></td>
									  </tr>
									</tbody>
								</thead>
							</table>
