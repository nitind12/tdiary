	...
	<table class="table  table-bordered table-condensed" id="fv" name="fv" >
			...
			<!--<table class="table" >-->
				...
				<tbody>
									  ...
									  <br>
									  <tr>
									  	 <td colspan="3">Husband/Wife Name:
									  	<input type="text" name="Husband/Wife Name" id="Husband/Wife Name"  class="span12" required/></td>
									  	<td colspan="3">D.O.B:
				...
				<tbody>
									  	<tr>
									   	<td colspan="3">Faculty Contact No:
									  	<input type="number" name="Faculty Contact No" id="Faculty Contact No" class="span12" required/></td>
									  	<td colspan="3" >Faculty Email:
									  	<input type="email" name="Faculty Email" id="Faculty Email" class="span12" required/></td>
									  </tr>
									  <tr>
									  <td colspan="3">Alternate Contact No:
									  	<input type="number" name="Alternate Contact No" id="Alternate Contact" class="span12" required/></td>
				...
				<tbody>
									  ...
									  <tr>
									  	...
									  	<input type="text" name="Post Graduation" class="span12" id="Post Graduation" required/></td>
									  ...
									  <tr>
									  	<td colspan="4">Teaching Experience:<br>
									  	<input type="text" name="Teaching Experience" id="Teaching Experience" class="span12" required/></td>
