					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h1 >contact_detail</h1>
							</div>
	<form method="post" action="<?php echo site_url('stu3c/savingdata50');?>" class="form-horizontal row-fluid">
	<table class="table table-striped table-bordered table-condensed" id="s3" name="s3" border="1">
			...
			<!--<table class="table" >-->
				...
				<tbody>
									...
									<tr>
										<td>std_email<br>
									  	<input type="email" name="std_email" id="std_email" class="span8" required/></td>
									    <td>std_contact<br>
									  	<input type="number" name="std_contact" id="std_contact" class="span8" required/></td>
									    <td>alternate_contact<br>
									  	<input type="number" name="alternate_contact" id="alternate_contact" class="span8" required/></td></tr>
									  	<tr>
									  	<td>contact_status<br>
									  	<select tabindex="1"data-placeholder="Select here.." class="span8" id="contact_status" name="contact_status" required/>
									  ...
									  <td>email_status<br>
									  	<select tabindex="1"data-placeholder="Select here.." class="span8" id="email_status" name="email_status" required/>
									  	<option value ="Yes">Select here..</option>
									  	<option value ="No">0</option>
									  	<option value ="No">1</option>
									    </select></td>
									  ...
									  <td>status<br>
				                       ...
				                       <td>alternate_email<br>
									  	<input type="email" name="alternate_email" id="alternate_email" class="span8" required/></td>
									  	<td>std_id<br>
									  	<input type="number" name="std_id" id="std_id" class="span8" required/></td>
									  	<td>username<br>
									  	<input type="text" name="username" id="username" class="span8" required/></td></tr>
									  </tbody>
									</thead>
								</table>
		...
		<?php foreach ($users as $item) { ?>
			<tr >
				...
				<td><a href="<?php echo site_url('stu3c/del1/' . $item->std_id)?>" class="btn " onclick="return confirm('Are you sure')">Delete</a></td>
