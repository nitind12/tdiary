	...
	<table class="table table-striped table-bordered table-condensed"  border="1">
				...
				<tbody>
									...
									<tr>
									  ...
									  <td>Semester_id<br>
									  	...
									  	<select tabindex="1"data-placeholder="Select here.." class="span8" name="Semester_id" id="Semester_id">
									  		<option value ="">Select here..</option>
									...
									<tr>
									  ...
									  <td>Faculty_id<br>
									  	<input type="text" name="Faculty_id" id="Faculty_id"class="span9"/></td>
									  <td>Time_table_id<br>
									  	<input type="text" name="Time_table_id" id="Time_table_id" class="span9"/></td>
									  <td>Time<br>
									  	<input type="text" name="Time" id="Time" class="span9"/></td>
									</tr>
								...
								<div class="control-group">
									...
									<center><a href="<?php echo site_url('edittimetablecontroller/del/' )?>" class="btn " onclick="return confirm('Are you sure to delete whole data from the table??')">Delete Whole Data From the Table!</a></center>
									<br>
										<table border="1" cellpadding="5" cellspacing="5" width="40%" align="center">

		<tr style="text-align: left">
			<th align="center">Day</th>
			<th align="center">Semester_id</th>
		...
		<?php foreach ($users as $item) { ?>
			<tr >
				...
				<td align="center"><?php echo $item->Semester_id;?></td>
				...
				<td align="center"><?php echo $item->Faculty_id;?></td>
				<td align="center"><?php echo $item->Time_table_id;?></td>
				<td align="center"><?php echo $item->Time;?></td>
				<td align="center"><?php echo $item->Room;?></td>
				<td><a href="<?php echo site_url('edittimetablecontroller/del1/' . $item->Time_table_id)?>" class="btn " onclick="return confirm('Are you sure')">Delete</a></td>
