...
<form method="post" action="<?php echo site_url('stu1c/index');?>" class="form-horizontal row-fluid">
		<div class="control-group">
			<label class="control-label" for="basicinput"></label>
				<div class="controls">
					<input type="text" id="basicinput" placeholder="student name..." class="span8">
				</div>
		</div>
        <div class="control-group">
		    <label class="control-label" for="basicinput"></label>
		...
		<div class="control-group">
		    <label class="control-label" for="basicinput"></label>
				<div class="controls">
					<input type="text" type="text" placeholder="mother's name…"  class="span8 tip">
				</div>
		</div><br>
						...
						<div class="controls">
							<select tabindex="1" data-placeholder="Select here.." class="span8">
								...
								<option value="Category 3">Other</option>
										...
										<div class="control-group">
											<div class="controls">
												<a href="<?php echo site_url('stu2c/index');?>"><button type="submit" class="btn">Save & Next</button></a>
											</div>
										</div>
									</form>
							</div>
