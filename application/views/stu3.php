...
<form class="form-horizontal row-fluid">
		<div class="control-group">
			<label class="control-label" for="basicinput"></label>
				<div class="controls">
					<input type="text" id="basicinput" placeholder="10th board..." class="span8">
				</div>
		</div>
        <div class="control-group">
		    <label class="control-label" for="basicinput"></label>
				<div class="controls">
					<input type="text" id="basicinput" placeholder="10th percent..." class="span8">
				</div>
		</div>
		...
		<div class="control-group">
		    <label class="control-label" for="basicinput"></label>
				<div class="controls">
					<input type="numeric" type="text" placeholder="10th passing year..."  class="span8 tip">
				</div><br>
				<div class="controls">
					<input type="numeric" type="text" placeholder="12th board..."  class="span8 tip">
				</div>
		</div><br>
		<div class="controls">
					<input type="text" type="text" placeholder="12th percent..."  class="span8 tip">
				</div><br>
				<div class="controls">
					<input type="text" type="text" placeholder="12th passing year"  class="span8 tip">
				</div><br>
				<div class="controls">
					<input type="text" type="text" placeholder="City…"  class="applying for course">
				</div><br>
				<!--<div class="controls">
				...
				<div class="controls">
					<input type="numeric" type="text" placeholder="pincode…"  class="span8 tip">
										...
										<div class="control-group">
											<label class="control-label" for="basicinput">Other Diploma or certificate</label>
											<div class="controls">
