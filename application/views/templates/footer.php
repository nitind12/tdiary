       <script type="text/javascript" src="<?php echo base_url('assets/js/jquery-1.9.1.min.js'); ?>" ></script>
        ...
        <script type="text/javascript" src="<?php echo base_url('assets/js/ravi.js');?>?version=8.9"></script>
        ...
        <script type="text/javascript" src="<?php echo base_url('assets/js/preeti.js');?>?version=7.7"></script>
